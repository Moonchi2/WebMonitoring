<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        @if ($role == 'Admin' || $role == 'Guru' || $role == 'Orang Tua')
            <div class="sidebar-brand">
                <a href="{{ route('dashboard.index') }}">
                    <img src="{{ asset('img/bg/logo.png') }}" alt="Logo" style="width: 80px; height: auto;">
                </a>
            </div>
            <div class="sidebar-brand sidebar-brand-sm">
                <a href="{{ route('dashboard.index') }}">
                    <img src="{{ asset('img/bg/logo.png') }}" alt="Logo" style="width: 40px; height: auto;">
                </a>
            </div>
            ...
            <ul class="sidebar-menu">
                ...
                @if ($role === 'Admin')
                    ...
                    <li class="nav-item dropdown {{ $type_menu === 'santri' ? 'active' : '' }}">
